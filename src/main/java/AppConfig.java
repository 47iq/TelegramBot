...
public class AppConfig {
    ...
    @Bean
    @Scope
    public Map<Command, KeyboardType> backButtonMap() {
        Map<Command, KeyboardType> backButtonMap = new HashMap<>();
        backButtonMap.put(getRegisterCommand(), KeyboardType.MENU);
        backButtonMap.put(getHelpCommand(), KeyboardType.MENU);
        backButtonMap.put(getBackCommand(), KeyboardType.MENU);
        backButtonMap.put(getStartCommand(), KeyboardType.MENU);
        backButtonMap.put(getOpenBasicCommand(), KeyboardType.BUY_BOX);
        backButtonMap.put(getOpenAdvancedCommand(), KeyboardType.BUY_BOX);
        backButtonMap.put(getOpenProCommand(), KeyboardType.BUY_BOX);
        backButtonMap.put(getMyCardsCommand(), KeyboardType.MENU);
        backButtonMap.put(getViewCommand(), KeyboardType.MENU);
        backButtonMap.put(getNavigateToCardCommand(), KeyboardType.MENU);
        backButtonMap.put(getShopCommand(), KeyboardType.MENU);
        backButtonMap.put(getBuyBoostCommand(), KeyboardType.BUY_ITEM);
        backButtonMap.put(getStatsCommand(), KeyboardType.MENU);
        backButtonMap.put(getBuyHealCommand(), KeyboardType.BUY_ITEM);
        backButtonMap.put(getFreeTokensCommand(), KeyboardType.SHOP);
        backButtonMap.put(getUseItemCommand(), KeyboardType.MENU);
        backButtonMap.put(getUseHealCommand(), KeyboardType.ITEM);
        backButtonMap.put(getUseBoostCommand(), KeyboardType.ITEM);
        backButtonMap.put(getHealCardCommand(), KeyboardType.ITEM);
        backButtonMap.put(getBoostCardCommand(), KeyboardType.ITEM);
        backButtonMap.put(getBuyBeerCommand(), KeyboardType.SHOP);
        backButtonMap.put(getSellCommand(), KeyboardType.CARDS);
        backButtonMap.put(getStartSearchCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getPrepareSearchCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getSellCardCommand(), KeyboardType.MENU);
        backButtonMap.put(getLeaveSearchCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getBattleMenuCommand(), KeyboardType.MENU);
        backButtonMap.put(getAppStatsCommand(), KeyboardType.STATS);
        backButtonMap.put(getGlobalStatsCommand(), KeyboardType.STATS);
        backButtonMap.put(getMyStatsCommand(), KeyboardType.STATS);
        backButtonMap.put(getDungeonMenuCommand(), KeyboardType.PVE_MENU);
        backButtonMap.put(getDungeonLeaveCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getDungeonEnterCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getDungeonEnterCardCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getDungeonNextCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getInfoCommand(), KeyboardType.MENU);
        backButtonMap.put(getItemInfoCommand(), KeyboardType.ITEM);
        backButtonMap.put(getDungeonInfoCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getShopInfoCommand(), KeyboardType.SHOP);
        backButtonMap.put(getBattleInfoCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getStartShopCommand(), KeyboardType.MENU);
        backButtonMap.put(getInstantHealCommand(), KeyboardType.QUEST);
        backButtonMap.put(getBuyItemCommand(), KeyboardType.SHOP);
        backButtonMap.put(getBuyBoxCommand(), KeyboardType.SHOP);
        backButtonMap.put(getAchievementsCommand(), KeyboardType.STATS);
        backButtonMap.put(getSetAttackCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getSetDefenceCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getBattleSubscribeCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getBattleUnsubscribeCommand(), KeyboardType.BATTLE);
        backButtonMap.put(getBuyCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getBuyCardCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getListCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getListCardCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getCancelCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getCancelCardCommand(), KeyboardType.MARKETPLACE);
        backButtonMap.put(getMarketplaceCommand(), KeyboardType.SHOP);
        backButtonMap.put(getTasksCommand(), KeyboardType.DUNGEON_MENU);
        backButtonMap.put(getContinueCommand(), KeyboardType.QUEST_MENU);
        backButtonMap.put(getChangeCommand(), KeyboardType.QUEST_MENU);
        backButtonMap.put(getStartFirstCommand(), KeyboardType.QUEST_MENU);
        backButtonMap.put(getStartFirstCardCommand(), KeyboardType.QUEST_MENU);
        backButtonMap.put(getChangeCardCommand(), KeyboardType.QUEST_SHOP);
        backButtonMap.put(getBuyUseHealCommand(), KeyboardType.QUEST_SHOP);
        backButtonMap.put(getQuestMenuCommand(), KeyboardType.PVE_MENU);
        backButtonMap.put(getQuestInstantHealCommand(), KeyboardType.QUEST_SHOP);
        backButtonMap.put(getPVEMenuCommand(), KeyboardType.MENU);
        return backButtonMap;
    }
