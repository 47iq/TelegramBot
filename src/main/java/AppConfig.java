...
public class AppConfig {
    ...
    public Map<Command, KeyboardType> keyboardTypeMap() {
        ...
        keyboardTypeMap.put(getShopCommand(), KeyboardType.MENU);
        ...
        keyboardTypeMap.put(getBattleMenuCommand(), KeyboardType.MENU);
        ...
        keyboardTypeMap.put(getDungeonMenuCommand(), KeyboardType.PVE_MENU);
        ...
        keyboardTypeMap.put(getQuestMenuCommand(), KeyboardType.PVE_MENU);
